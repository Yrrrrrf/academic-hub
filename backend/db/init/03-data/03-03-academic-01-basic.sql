...
BEGIN
    ...
    PERFORM add_course('c0101000-0000-4000-a000-000000000001'::UUID, 'PHYSICS-03', 7, 'Mecánica de la partícula', 'Estudio de las leyes fundamentales del movimiento de partículas', course_type);
    ...
    PERFORM add_course('c0405000-0000-4000-a000-000000000005'::UUID, 'PHYSICS-05', 7, 'Estática', 'Estudio de fuerzas en equilibrio', course_type);
        -- Chemistry
