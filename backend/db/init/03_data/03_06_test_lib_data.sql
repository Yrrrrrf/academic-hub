...
INSERT INTO infrastructure_management.faculty (id, name)
VALUES ('f1b0a112-9e88-4d1e-87a7-a5a6e6e73c3f', 'Engineering Faculty');

-- Set up buildings A, B, and C
INSERT INTO infrastructure_management.building (id, name, address, total_floors)
VALUES 
...
INSERT INTO infrastructure_management.faculty_building (faculty_id, building_id)
VALUES 
...
INSERT INTO infrastructure_management.library (id, name, faculty_id, building_id)
...
INSERT INTO academic_management.program (id, code, name, description, degree_level)
VALUES 
...
INSERT INTO student_management.student (id, first_name, last_name, enrollment_date, program_id)
VALUES 
...
-- Create authors
INSERT INTO library_management.author (id, name)
VALUES 
...
-- Create publishers
INSERT INTO library_management.publisher (id, name)
VALUES 
...
-- Create books
INSERT INTO library_management.book (id, title, publisher_id, isbn, publication_year)
VALUES 
...
INSERT INTO library_management.book_author (book_id, author_id)
VALUES 
...
INSERT INTO library_management.book_copy (id, book_id, library_id, status)
VALUES 
