...
BEGIN
    ...
    VALUES (p_id, p_code, p_title, p_description, p_credits, p_is_active)
...
-- Function to associate a course with a program
...
BEGIN
    ...
    v_course_id := add_course(p_course_id, p_code, p_credits, p_title, p_description, p_is_active);
